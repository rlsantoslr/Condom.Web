...
{
    public interface IIdentityUserPasswordStore<TEntity> : IUserPasswordStore<TEntity> where TEntity : Users
    {

    }
    public class IdentityUserPasswordStore : IIdentityUserPasswordStore<Users>
    {
